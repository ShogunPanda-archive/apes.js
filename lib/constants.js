...
/**
 * A set of common used constant values.
 *
 * @namespace Constants
 */
const Constants = {
  /**
   * Constants used for general purpose methods.
   *
   ...
   *
   * @namespace Constants.Serialization
   */
  Serialization: {
  ...
  /**
   * Constants used for HTTP handling.
   *
  ...
  HTTP: {
     ...
     *
     * @namespace Constants.HTTP.Statuses
     */
    Statuses: {
      OK: 200,
      CREATED: 201,
     ...
     *
     * @namespace Constants.HTTP.StatusClasses
     */
    StatusClasses: {
      SEPARATOR: 100,
      INFO: 1,
