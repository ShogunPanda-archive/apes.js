...
export namespace HTTP{
   ...
   */
  export function Profiler(req: express.Request, res: express.Response, next: express.NextFunction): void{
  ...
  export class Server extends Application{
    ...
    protected prepare(): Promise<winston.LoggerInstance | Logger | Error | void>{
      ...
      // Diagnostic ping
      this.express.get("/ping", (req: express.Request, res: express.Response) => {
