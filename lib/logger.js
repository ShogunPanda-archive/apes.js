...
class Logger {
    ...
    constructor(target, useConsole = false) {
        this.root = path.resolve(application_1.Application.root, "log");
        this.target = target;
    ...
    prepare() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const target = path.resolve(this.root, `${this.target}-${application_1.Application.environment}.log`);
                // Create transports
                const level = application_1.Application.debug ? "debug" : "verbose";
                const transports = [
     ...
     */
    debug(...args) {
        if (!application_1.Application.debug)
